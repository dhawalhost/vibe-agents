...
4. Install the App on your account or organisation and note the **Installation ID** from the URL (`.../installations/<ID>`).
5. Set `GITHUB_APP_ID`, `GITHUB_APP_INSTALLATION_ID`, and either `GITHUB_APP_PRIVATE_KEY` / `GITHUB_APP_PRIVATE_KEY_PATH` as shown above.
...
|----------|--------|------|
| **GitHub Copilot** (default) | gpt-4o, gpt-4o-mini, claude-sonnet-4, o1-preview | `GITHUB_APP_ID` + `GITHUB_APP_PRIVATE_KEY` + `GITHUB_APP_INSTALLATION_ID` **or** `GITHUB_TOKEN` |
